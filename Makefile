.PHONY: sync format lint type contracts storage-contracts ingress-contracts representation-contracts quanta-contracts relation-contracts transduction-governance-contracts external-representation-contracts agent-harness-contracts ecosystem-engine-contracts experiment-preparation-contracts test build smoke offline-smoke verify
